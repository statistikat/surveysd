...
`n` and denotes the number of observations for the year and `N` denotes the total weight of those
persons.
...
The last column with `region = NA` denotes the aggregate over all regions. Note that the
...
Split the data by all cobinations of the two grouping variables. This will result in a larger 
