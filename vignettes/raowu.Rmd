...
$$
where:<br>
 - \( w_{hi} \) is the design weight of unit \( i \) in stratum \( h \),<br>
 - \( r^*_{hi} \in \{0, 1, 2, \dots\} \) is a **counter** that indicates how many times unit \( i \) in stratum \( h \) has been selected in the replicate,<br>
 ...
 - and \( f_h = n_h / N_h \) is the sampling fraction in stratum \( h \), and \( N_h \) is the total number of units in stratum \( h \).<br>
