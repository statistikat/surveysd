...
kable(dat_after,format="latex",booktabs=TRUE,align=c("l","l","l","r"),caption = "Original household with 3 members and 1 split household in year 2014.")
@
