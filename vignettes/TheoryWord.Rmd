...
Consider a 4 member household that enters EU-SILC in the year 2013, as show in Table 1. For this household the bootstrap replicate was set to 2.
...
kable(dat_after,caption = "Original household with 3 members and 1 split household in year 2014.")
```

Table 2 shows the household members from Table 1 including a split household for the year 2014. We see that the household member with PID=4750003 has moved to a new household, thus creating the split household, HID=47501.
