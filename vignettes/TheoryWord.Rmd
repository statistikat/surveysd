...
$$
This can result in losing the population structure performed in steps 1-3.
...
erg_vardpoor <- varpoord(Y="arose",H="DB050",PSU="DB030",Dom="DB040",ID_level1 = "DB030",N_h=N_h,
...
num_obs <- rbindlist(list(dat_es[,.N,by=RB010],dat_es[,.N,by=list(RB010,DB040,DB100)]),use.names=TRUE,fill=TRUE)
