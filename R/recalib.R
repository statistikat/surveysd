...
#'
#' @details
#' `recalib` takes survey data (`dat`) containing the bootstrap replicates generated by [draw.bootstrap] and calibrates weights for each bootstrap
...
#' @param b.rep character specifying the names of the columns in `dat` containing bootstrap weights which should be recalibratet
...
recalib <- function(dat, hid = attr(dat, "hid"), weights = attr(dat, "weights"), b.rep = attr(dat, "b.rep"),
