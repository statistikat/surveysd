...
#'
#' @usage recalib(dat,hid="DB030",weights="RB050",b.rep=paste0("w",1:1000),
#'                period="year",conP.var=c("RB090"),conH.var=c("DB040","DB100"),...)
#'
#' @details
...
#' @param ... additional arguments passed on to function \code{\link[simPop]{ipu2}} from the \code{simPop} package.
#'
#'
...
#'
#'
#' @seealso \code{\link[simPop]{ipu2}} for more information on iterative proportional fitting.
#'
...
recalib <- function(dat,hid="DB030",weights="RB050",b.rep=paste0("w",1:1000),period="year",conP.var=c("RB090"),
  ...
  verbose <- epsP <- epsH <- bound <- maxiter <- meanHH <- check_hh_vars <- hidfactor <- NULL
