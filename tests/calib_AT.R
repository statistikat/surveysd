...
write.csv2(dat_boot,file="/mnt/obdatenaustausch/NETSILC3/udb_AT_bootweight_1000.csv")
...
write.csv2(dat_boot_calib,file="/mnt/obdatenaustausch/NETSILC3/udb_AT_calib_1000.csv")
