...
set.seed(1234)
dat_boot <- draw.bootstrap(dat=copy(dat_at),REP=250,hid="db030",weights="RB050",strata="DB040",
                           year="RB010",split=TRUE,pid="RB030")

write.csv2(dat_boot,file="/mnt/obdatenaustausch/NETSILC3/udb_AT_bootweight.csv")
...
write.csv2(dat_boot_calib,file="/mnt/obdatenaustausch/NETSILC3/udb_AT_calib.csv")
