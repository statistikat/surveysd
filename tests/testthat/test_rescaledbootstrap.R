...
test_that("test para - data",{
  ...
  expect_error(rescaled.bootstrap(eusilc,REP=100,strata="db040",cluster="db030",fpc="N.households"),NA)
})
...
test_that("test para - strata, cluster and fpc",{
  ...
  expect_error(rescaled.bootstrap(eusilc,REP=100,strata="db040",cluster="I",fpc="N.households"),NA)
  expect_error(rescaled.bootstrap(eusilc,REP=100,strata="db040",cluster="1",fpc="N.households"),NA)
  expect_error(rescaled.bootstrap(eusilc,REP=100,strata="1",cluster="db030",fpc="N.households.all"),NA)
  expect_error(rescaled.bootstrap(eusilc,REP=100,strata="I",cluster="db030",fpc="N.households.all"),NA)
})


test_that("test para - check.input",{
  expect_error(rescaled.bootstrap(eusilc,REP=100,strata="db040",cluster="db030",fpc="N.households",check.input=FALSE),NA)
