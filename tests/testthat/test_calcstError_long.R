...
# these are some longer tests
  ...
  test_that("test para -  var and fun",{
    ...
    expect_error(calc.stError(eusilc,weights="db090",b.weights=paste0("w",1:2),period="year",var="povmd60s",
                              group=c("rb090","db040")),"Not all elements in var are column names in dat")

    eusilc[sample(.N,100),povmd60NA:=NA]
    expect_error(calc.stError(eusilc,weights="db090",b.weights=paste0("w",1:2),period="year",var="povmd60NA",
    ...
    expect_error(calc.stError(eusilc,weights="db090",b.weights=paste0("w",1:2),period="year",var="eqIncome",
  ...
  test_that("test para - fun.adjust.var and adjust.var",{
    ...
    expect_error(calc.stError(eusilc,weights="rb050",b.weights=paste0("w",1:2),
    ...
    err.est <- calc.stError(eusilc,weights="rb050",b.weights=paste0("w",1:2),
                            period="year",var="povmd60",fun=weightedRatio,
    ...
    err.est.different <- calc.stError(eusilc,weights="rb050",b.weights=paste0("w",1:2),
  ...
  test_that("test para -  add.arg",{
    ...
    res_1 <- calc.stError(eusilc,weights="db090",b.weights=paste0("w",1:2),period="year",var="eqIncome",
    ...
    res_2 <- calc.stError(eusilc,weights="db090",b.weights=paste0("w",1:2),period="year",var="eqIncome",
